...
//    }()
    ...
    private func setupUI(){
        ...
        stackView.addArrangedSubview(historyTextView)
        stackView.addArrangedSubview(rulesTextView)
        stackView.addArrangedSubview(tournamentStackView)
        ...
        constraints.append(stackView.topAnchor.constraint(equalTo: scrollView.safeAreaLayoutGuide.topAnchor))
        constraints.append(stackView.bottomAnchor.constraint(equalTo: scrollView.safeAreaLayoutGuide.bottomAnchor))
        constraints.append(stackView.leadingAnchor.constraint(equalTo: scrollView.safeAreaLayoutGuide.leadingAnchor))
        constraints.append(stackView.trailingAnchor.constraint(equalTo: scrollView.safeAreaLayoutGuide.trailingAnchor))
        
//        constraints.append(pastButton.topAnchor.constraint(equalTo: tournamentsView.safeAreaLayoutGuide.topAnchor, constant: 10))
//        constraints.append(pastButton.leadingAnchor.constraint(equalTo: tournamentsView.safeAreaLayoutGuide.leadingAnchor, constant: 10))
//        constraints.append(pastButton.trailingAnchor.constraint(equalTo: tournamentsView.safeAreaLayoutGuide.trailingAnchor, constant: 10))
//
//      constraints.append(futureButton.topAnchor.constraint(equalTo: tournamentsView.safeAreaLayoutGuide.topAnchor, constant: 40))
//        constraints.append(futureButton.leadingAnchor.constraint(equalTo: pastButton.safeAreaLayoutGuide.leadingAnchor, constant: 80))
//        constraints.append(futureButton.trailingAnchor.constraint(equalTo: tournamentsView.safeAreaLayoutGuide.trailingAnchor, constant: 10))
